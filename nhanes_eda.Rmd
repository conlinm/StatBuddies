...
12. Finally, let's add `nPregnancies` as pregnancy has an effect on body mass. 
...
df_keep = data.frame(predictor = c('SurveyYr', 'Age', 'Age1stBaby', 'AlcoholYear', 'Marijuana', 'SmokeNow', 'HardDrugs', 'BPDiaAve', 'BPSysAve', 'PhysActiveDays', 'TVHrsDay', 'CompHrsDay', 'TotChol', 'Diabetes', 'UrineVol1', 'HealthGen', 'LittleInterest', 'nPregnancies'))
#kable(df_exclude)

#Discuss if these are others we want to keep:
# need to convert to factor: Gender, Race1, SexOrientation, Education, MaritalStatus, SleepTrouble
# Poverty, Pulse
# Testosterone (Reported for participants aged 6 years or older. Not available for 2009-2010.)
# SleepHrsNight
#Added SurveyYr
```
...
* We can try including some other predictor variables listed in the Data selection area.
