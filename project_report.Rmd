...
Lastly, let's try a Stepwise seach in both directions using AIC.
...
Additionally, we want to check which variables are correlated with BMI to further investigate possible interaction terms.  
...
nhanes_numerical_subset = nhanes[, c('Age', 'AlcoholYear', 'BPDiaAve', 'BPSysAve', 'UrineVol1', 'SleepHrsNight', 'TotChol' ,'BMI')]  
...
nhanes_categorical_subset = nhanes[, c('Marijuana', 'SmokeNow', 'HardDrugs', 'Diabetes', 'LittleInterest', 'TVHrsDay', 'CompHrsDay',  'BMI')]   
