...
This was a very educational and productive project. We found motivation for our project in investigating a significant health problem - obesity. We utilized one of the most widely used data sources for healthcare studies, the National Health and Nutrition Examination (NHANES), which we described in the introduction. We were surprised to find a large amount of missing data, but benefited from learning about data imputation, and using the `mice` package to complete our dataset. Using the procedures of variable selection, model building, model assessment, and others that were learned in the class, we found three useful models.
